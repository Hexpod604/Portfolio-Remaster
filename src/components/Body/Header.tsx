    ...
    <section className="bg-black">
      <div className="flex md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg 2xl:max-w-screen-xl px-4 lg:px-0 mx-auto lg:gap-8 xl:gap-0 py-16">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-2 text-3xl sm:text-4xl font-bold tracking-tight leading-none md:text-5xl xl:text-6xl text-white">
            Lautaro Spiazzi
          </h1>
          <h2 className="max-w-2xl mb-4 font-semibold md:text-2xl xl:text-3xl text-yellow-300">
            Desarrollador web
          </h2>
          <p className="max-w-2xl mb-6 font-light lg:mb-8 text-md md:text-lg lg:text-xl text-gray-300">
            Combinando mi{" "}
