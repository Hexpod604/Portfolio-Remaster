      ...
      <div className="py-8 lg:py-16 mx-auto md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg 2xl:max-w-screen-xl px-4">
        ...
        <div className="flex justify-center items-center flex-col sm:flex-row flex-wrap gap-8 sm:gap-16 text-gray-500 text-gray-400">
          <Link
            ...
            target="_BLANK"
            className="flex justify-center items-center duration-100 hover:!transform hover:!delay-0 hover:-translate-y-[3px]"
          >
            <Image
          ...
          <Link
            ...
            target="_BLANK"
            className="flex gap-2 justify-center items-center duration-100 hover:!transform hover:!delay-0 hover:-translate-y-[3px]"
          >
            <Image
