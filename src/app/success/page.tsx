    ...
    <>
      ...
      <main className="flex items-center justify-center">
        <div
          id="successModal"
          tabIndex={-1}
          className="overflow-y-auto overflow-x-hidden m-auto z-50 justify-center items-center w-full md:inset-0 md:h-full"
        >
          <div className="relative p-4 w-full max-w-md h-full md:h-auto m-auto">
            <div className="relative p-4 text-center rounded-lg shadow bg-gray-800 sm:p-5 flex flex-col gap-3">
              <svg
                viewBox="0 0 117 117"
                version="1.1"
              ...
              <Link
                ...
                href="/"
                className="py-2 px-3 text-sm font-medium text-center text-white rounded-lg bg-blue-800 hover:bg-blue-900 focus:outline-none"
              >
                Regresar al inicio
              </Link>
            </div>
