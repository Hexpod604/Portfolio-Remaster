...
export const metadata: Metadata = {
  ...
  description:
    "Desarrollador web apasionado con 4 años de aprendizaje, tanto en front-end como en back-end con variedad de tecnologías presentes en la industria actual.",
